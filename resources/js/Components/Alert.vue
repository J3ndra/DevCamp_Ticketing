...
<template>
    <BlankDialog :showModal="openDialog" :size="size">
        <template v-slot:content>
            <div class="text-center w-full">
                <!-- Icon -->
                <div
                    class="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-rose-100 mx-auto"
                    v-if="type === 'danger'"
                >
                    <svg
                ...
                <div
                    class="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-indigo-100 mx-auto"
                    v-else-if="type === 'info'"
                >
                    <svg

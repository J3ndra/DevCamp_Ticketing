...
import EditIconVue from "./src/Icons/EditIcon.vue";
            ...
            :class="[
                {
                    ...
                    'bg-primary hover:bg-primary-hover text-black':
                        type === 'primary',
                    'bg-danger hover:bg-danger-hover text-black':
                        type === 'danger',
                    'bg-success hover:bg-success-hover text-black':
                        type === 'success',
                    'bg-white hover:text-tertiary-hover text-tertiary':
                        type === 'default',
                    'bg-white hover:bg-slate-200 text-blue-500':
